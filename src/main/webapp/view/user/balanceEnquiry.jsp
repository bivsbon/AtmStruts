...
<body>
	...
	<h1>Balance: $<bean:write name="balance"/> <br> </h1>
	
	<form action="user-balance-enquiry-filter.do" method="POST">
		Filter : <input type="date" name="startDate" value="<logic:notEmpty name="startDate"><bean:write name="startDate"/></logic:notEmpty>" required> to <input type="date" name="endDate" value="<logic:notEmpty name="endDate"><bean:write name="endDate"/></logic:notEmpty>" required>
		<button type="submit">Apply</button>
	</form>
	
  	<p style="color: red; display: inline">
  		<html:errors property="filter.date.invalid"/>
  	</p><br>
	...
	<html:link forward="user-mainpanel"><button><bean:message key="button.backToMainPage"/></button></html:link>
	<html:link action="/user-export-excel.do"><button style="float: right"><bean:message key="button.export"/></button></html:link>
</body>
</html>