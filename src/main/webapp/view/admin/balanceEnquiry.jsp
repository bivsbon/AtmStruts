...
<body>
	...
	<form action="admin-balance-enquiry-filter.do" method="POST">
		Filter : <input type="date" name="startDate" required> to <input type="date" name="endDate">
	...
	<html:link forward="user-operations"><button><bean:message key="button.backToMainPage"/></button></html:link>
	<html:link action="/admin-export-excel.do"><button style="float: right"><bean:message key="button.export"/></button></html:link>
</body>
</html>